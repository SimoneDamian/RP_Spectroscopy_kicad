...
(library Library_1
	...
	(compDef "TL081CDR" (originalName "TL081CDR") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		...
		(compPin "5" (pinName "OFFSET N2") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attr "<Hyperlink>" "http://www.ti.com/lit/ds/symlink/tl081.pdf")
		(attr "<Component Height>" "1.75")
		(attr "<STEP Filename>" "TL081CDR.stp")
